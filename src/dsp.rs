...
impl FaustDsp for mydsp {
	...
	fn compute(&mut self, count: i32, inputs: &[&[Self::T]], outputs: &mut[&mut[Self::T]]) {
		...
		for (output0, output1) in zipped_iterators {
			...
			let mut fTemp11: F32 = self.fConst3 * fTemp10;
			let mut fTemp12: F32 = self.fRec13[1] + fTemp11;
			let mut fTemp13: F32 = fTemp12 + -1.0;
			let mut iTemp14: i32 = ((fTemp13 < 0.0) as i32);
			self.fRec13[0] = if (iTemp14 as i32 != 0) { fTemp12 } else { fTemp13 };
			let mut fThen5: F32 = fTemp11 + self.fRec13[1] + fTemp13 * (1.0 - self.fConst0 / fTemp10);
			let mut fRec14: F32 = if (iTemp14 as i32 != 0) { fTemp12 } else { fThen5 };
			self.fRec15[0] = fSlow6 + self.fConst2 * self.fRec15[1];
			let mut fTemp15: F32 = F32::min(1.41419947, 1.41421354 * self.fRec15[0]);
			let mut fTemp16: F32 = fTemp15 * (fTemp15 + 1.41421354);
			self.fRec16[0] = fSlow7 + self.fConst2 * self.fRec16[1];
			let mut fTemp17: F32 = F32::tan(self.fConst4 * F32::max(20.0, F32::min(10000.0, 440.0 * F32::powf(2.0, 0.0833333358 * (fTemp0 + self.fRec16[0] + -69.0)))));
			let mut fTemp18: F32 = 1.0 / fTemp17;
			let mut fTemp19: F32 = 1.41421354 * fTemp15;
			let mut fTemp20: F32 = fTemp19 + 2.0;
			let mut fTemp21: F32 = 1.0 - 1.0 / mydsp_faustpower2_f(fTemp17);
			let mut fTemp22: F32 = fTemp16 + (fTemp18 + fTemp20) / fTemp17 + 1.0;
			self.fRec4[0] = 2.0 * fRec6 + self.fRec9[0] * (0.0 - 2.0 * (1.0 - (fRec11 + fRec14))) + -1.0 - (self.fRec4[2] * (fTemp16 + (fTemp18 - fTemp20) / fTemp17 + 1.0) + 2.0 * self.fRec4[1] * (fTemp16 + fTemp21)) / fTemp22;
			let mut fTemp23: F32 = fTemp15 * (fTemp15 + -1.41421354);
			let mut fTemp24: F32 = 2.0 - fTemp19;
			let mut fTemp25: F32 = fTemp23 + (fTemp24 + fTemp18) / fTemp17 + 1.0;
			self.fRec3[0] = (self.fRec4[2] + self.fRec4[0] + 2.0 * self.fRec4[1]) / fTemp22 - (self.fRec3[2] * (fTemp23 + (fTemp18 - fTemp24) / fTemp17 + 1.0) + 2.0 * self.fRec3[1] * (fTemp23 + fTemp21)) / fTemp25;
			self.fRec17[0] = fSlow8 + self.fConst2 * self.fRec17[1];
			self.fRec22[0] = fSlow9 + self.fConst2 * self.fRec22[1];
			let mut fTemp26: F32 = self.fRec8[0] + self.fRec22[0];
			let mut fTemp27: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (fTemp26 + -69.0))));
			let mut fTemp28: F32 = self.fConst3 * fTemp27;
			let mut fTemp29: F32 = self.fRec20[1] + fTemp28;
			...
			let mut fThen7: F32 = fTemp28 + self.fRec20[1] + fTemp30 * (1.0 - self.fConst0 / fTemp27);
			...
			let mut fTemp34: F32 = self.fRec23[1] + self.fConst3 * fTemp33;
			...
			let mut fThen9: F32 = fTemp34 + fTemp35 * (1.0 - self.fConst0 / fTemp33);
			let mut fRec24: F32 = if (iTemp36 as i32 != 0) { fTemp34 } else { fThen9 };
			let mut fTemp37: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (fTemp26 + fTemp9))));
			let mut fTemp38: F32 = self.fConst3 * fTemp37;
			let mut fTemp39: F32 = self.fRec25[1] + fTemp38;
			let mut fTemp40: F32 = fTemp39 + -1.0;
			let mut iTemp41: i32 = ((fTemp40 < 0.0) as i32);
			self.fRec25[0] = if (iTemp41 as i32 != 0) { fTemp39 } else { fTemp40 };
			let mut fThen11: F32 = fTemp38 + self.fRec25[1] + fTemp40 * (1.0 - self.fConst0 / fTemp37);
			let mut fRec26: F32 = if (iTemp41 as i32 != 0) { fTemp39 } else { fThen11 };
			let mut fTemp42: F32 = self.fRec8[0] + self.fRec16[0];
			let mut fTemp43: F32 = F32::tan(self.fConst4 * F32::max(20.0, F32::min(10000.0, 440.0 * F32::powf(2.0, 0.0833333358 * (self.fRec22[0] + fTemp42 + -69.0)))));
			let mut fTemp44: F32 = 1.0 / fTemp43;
			let mut fTemp45: F32 = 1.0 - 1.0 / mydsp_faustpower2_f(fTemp43);
			let mut fTemp46: F32 = fTemp16 + (fTemp20 + fTemp44) / fTemp43 + 1.0;
			self.fRec19[0] = 2.0 * fRec21 + self.fRec9[0] * (0.0 - 2.0 * (1.0 - (fRec24 + fRec26))) + -1.0 - (self.fRec19[2] * (fTemp16 + (fTemp44 - fTemp20) / fTemp43 + 1.0) + 2.0 * self.fRec19[1] * (fTemp16 + fTemp45)) / fTemp46;
			let mut fTemp47: F32 = fTemp23 + (fTemp24 + fTemp44) / fTemp43 + 1.0;
			self.fRec18[0] = (self.fRec19[2] + self.fRec19[0] + 2.0 * self.fRec19[1]) / fTemp46 - (self.fRec18[2] * (fTemp23 + (fTemp44 - fTemp24) / fTemp43 + 1.0) + 2.0 * self.fRec18[1] * (fTemp23 + fTemp45)) / fTemp47;
			self.fRec27[0] = fSlow10 + self.fConst2 * self.fRec27[1];
			self.fRec32[0] = fSlow11 + self.fConst2 * self.fRec32[1];
			let mut fTemp48: F32 = self.fRec8[0] + self.fRec32[0];
			let mut fTemp49: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (fTemp48 + -69.0))));
			let mut fTemp50: F32 = self.fConst3 * fTemp49;
			let mut fTemp51: F32 = self.fRec30[1] + fTemp50;
			...
			let mut fThen13: F32 = self.fRec30[1] + fTemp50 + fTemp52 * (1.0 - self.fConst0 / fTemp49);
			...
			let mut fTemp58: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (fTemp48 + fTemp9))));
			let mut fTemp59: F32 = self.fConst3 * fTemp58;
			let mut fTemp60: F32 = self.fRec35[1] + fTemp59;
			let mut fTemp61: F32 = fTemp60 + -1.0;
			let mut iTemp62: i32 = ((fTemp61 < 0.0) as i32);
			self.fRec35[0] = if (iTemp62 as i32 != 0) { fTemp60 } else { fTemp61 };
			let mut fThen17: F32 = fTemp59 + self.fRec35[1] + fTemp61 * (1.0 - self.fConst0 / fTemp58);
			let mut fRec36: F32 = if (iTemp62 as i32 != 0) { fTemp60 } else { fThen17 };
			let mut fTemp63: F32 = F32::tan(self.fConst4 * F32::max(20.0, F32::min(10000.0, 440.0 * F32::powf(2.0, 0.0833333358 * (self.fRec32[0] + fTemp42 + -69.0)))));
			let mut fTemp64: F32 = 1.0 / fTemp63;
			let mut fTemp65: F32 = 1.0 - 1.0 / mydsp_faustpower2_f(fTemp63);
			let mut fTemp66: F32 = fTemp16 + (fTemp20 + fTemp64) / fTemp63 + 1.0;
			self.fRec29[0] = 2.0 * fRec31 + self.fRec9[0] * (0.0 - 2.0 * (1.0 - (fRec34 + fRec36))) + -1.0 - (self.fRec29[2] * (fTemp16 + 1.0 - (fTemp20 - fTemp64) / fTemp63) + 2.0 * self.fRec29[1] * (fTemp16 + fTemp65)) / fTemp66;
			let mut fTemp67: F32 = fTemp23 + (fTemp24 + fTemp64) / fTemp63 + 1.0;
			self.fRec28[0] = (self.fRec29[2] + self.fRec29[0] + 2.0 * self.fRec29[1]) / fTemp66 - (self.fRec28[2] * (fTemp23 + (fTemp64 - fTemp24) / fTemp63 + 1.0) + 2.0 * self.fRec28[1] * (fTemp23 + fTemp65)) / fTemp67;
			self.fRec37[0] = fSlow12 + self.fConst2 * self.fRec37[1];
			self.fRec42[0] = fSlow13 + self.fConst2 * self.fRec42[1];
			let mut fTemp68: F32 = self.fRec8[0] + self.fRec42[0];
			let mut fTemp69: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (fTemp68 + -69.0))));
			let mut fTemp70: F32 = self.fConst3 * fTemp69;
			let mut fTemp71: F32 = self.fRec40[1] + fTemp70;
			let mut fTemp72: F32 = fTemp71 + -1.0;
			let mut iTemp73: i32 = ((fTemp72 < 0.0) as i32);
			self.fRec40[0] = if (iTemp73 as i32 != 0) { fTemp71 } else { fTemp72 };
			let mut fThen19: F32 = fTemp70 + self.fRec40[1] + fTemp72 * (1.0 - self.fConst0 / fTemp69);
			let mut fRec41: F32 = if (iTemp73 as i32 != 0) { fTemp71 } else { fThen19 };
			let mut fTemp74: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (self.fRec42[0] + fTemp32 + -69.0))));
			let mut fTemp75: F32 = self.fConst3 * fTemp74;
			let mut fTemp76: F32 = self.fRec43[1] + fTemp75;
			let mut fTemp77: F32 = fTemp76 + -1.0;
			let mut iTemp78: i32 = ((fTemp77 < 0.0) as i32);
			self.fRec43[0] = if (iTemp78 as i32 != 0) { fTemp76 } else { fTemp77 };
			let mut fThen21: F32 = fTemp75 + self.fRec43[1] + fTemp77 * (1.0 - self.fConst0 / fTemp74);
			let mut fRec44: F32 = if (iTemp78 as i32 != 0) { fTemp76 } else { fThen21 };
			let mut fTemp79: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (fTemp68 + fTemp9))));
			let mut fTemp80: F32 = self.fRec45[1] + self.fConst3 * fTemp79;
			let mut fTemp81: F32 = fTemp80 + -1.0;
			let mut iTemp82: i32 = ((fTemp81 < 0.0) as i32);
			self.fRec45[0] = if (iTemp82 as i32 != 0) { fTemp80 } else { fTemp81 };
			let mut fThen23: F32 = fTemp80 + fTemp81 * (1.0 - self.fConst0 / fTemp79);
			let mut fRec46: F32 = if (iTemp82 as i32 != 0) { fTemp80 } else { fThen23 };
			let mut fTemp83: F32 = F32::tan(self.fConst4 * F32::max(20.0, F32::min(10000.0, 440.0 * F32::powf(2.0, 0.0833333358 * (self.fRec42[0] + fTemp42 + -69.0)))));
			let mut fTemp84: F32 = 1.0 / fTemp83;
			let mut fTemp85: F32 = 1.0 - 1.0 / mydsp_faustpower2_f(fTemp83);
			let mut fTemp86: F32 = fTemp16 + (fTemp20 + fTemp84) / fTemp83 + 1.0;
			self.fRec39[0] = 2.0 * fRec41 + self.fRec9[0] * (0.0 - 2.0 * (1.0 - (fRec44 + fRec46))) + -1.0 - (self.fRec39[2] * (fTemp16 + 1.0 - (fTemp20 - fTemp84) / fTemp83) + 2.0 * self.fRec39[1] * (fTemp16 + fTemp85)) / fTemp86;
			let mut fTemp87: F32 = fTemp23 + (fTemp24 + fTemp84) / fTemp83 + 1.0;
			self.fRec38[0] = (self.fRec39[2] + self.fRec39[0] + 2.0 * self.fRec39[1]) / fTemp86 - (self.fRec38[2] * (fTemp23 + (fTemp84 - fTemp24) / fTemp83 + 1.0) + 2.0 * self.fRec38[1] * (fTemp23 + fTemp85)) / fTemp87;
			self.fRec47[0] = fSlow14 + self.fConst2 * self.fRec47[1];
			self.fRec49[0] = fSlow15 + self.fConst2 * self.fRec49[1];
			let mut fTemp88: F32 = F32::powf(2.0, 0.0833333358 * (self.fRec49[0] + -69.0));
			let mut fTemp89: F32 = F32::max(440.0 * fTemp88, 23.4489498);
			let mut fTemp90: F32 = F32::max(0.0, F32::min(2047.0, self.fConst7 / fTemp89));
			let mut fTemp91: F32 = F32::floor(fTemp90);
			let mut fTemp92: F32 = ((self.iVec0[1]) as F32);
			let mut fTemp93: F32 = F32::max(20.0, F32::abs(fTemp89));
			let mut fTemp94: F32 = self.fRec50[1] + self.fConst3 * fTemp93;
			self.fRec50[0] = fTemp94 - F32::floor(fTemp94);
			let mut fTemp95: F32 = mydsp_faustpower2_f(2.0 * self.fRec50[0] + -1.0);
			self.fVec1[0] = fTemp95;
			let mut fTemp96: F32 = (fTemp92 * (fTemp95 - self.fVec1[1])) / fTemp93;
			self.fVec2[(self.IOTA0 & 4095) as usize] = fTemp96;
			let mut iTemp97: i32 = ((fTemp90) as i32);
			self.fRec48[0] = 0.999000013 * self.fRec48[1] - self.fConst6 * ((fTemp90 - fTemp91) * self.fVec2[((self.IOTA0 - (iTemp97 + 1)) & 4095) as usize] - fTemp96 - self.fVec2[((self.IOTA0 - iTemp97) & 4095) as usize] * (fTemp91 + 1.0 - fTemp90));
			let mut fTemp98: F32 = F32::powf(2.0, 0.0833333358 * (self.fRec49[0] + -56.9000015));
			let mut fTemp99: F32 = F32::max(440.0 * fTemp98, 23.4489498);
			let mut fTemp100: F32 = F32::max(20.0, F32::abs(fTemp99));
			let mut fTemp101: F32 = self.fRec52[1] + self.fConst3 * fTemp100;
			self.fRec52[0] = fTemp101 - F32::floor(fTemp101);
			let mut fTemp102: F32 = mydsp_faustpower2_f(2.0 * self.fRec52[0] + -1.0);
			self.fVec3[0] = fTemp102;
			let mut fTemp103: F32 = (fTemp92 * (fTemp102 - self.fVec3[1])) / fTemp100;
			self.fVec4[(self.IOTA0 & 4095) as usize] = fTemp103;
			let mut fTemp104: F32 = F32::max(0.0, F32::min(2047.0, self.fConst7 / fTemp99));
			let mut iTemp105: i32 = ((fTemp104) as i32);
			let mut fTemp106: F32 = F32::floor(fTemp104);
			self.fRec51[0] = 0.999000013 * self.fRec51[1] + self.fConst6 * (fTemp103 - self.fVec4[((self.IOTA0 - iTemp105) & 4095) as usize] * (fTemp106 + 1.0 - fTemp104) - (fTemp104 - fTemp106) * self.fVec4[((self.IOTA0 - (iTemp105 + 1)) & 4095) as usize]);
			let mut fTemp107: F32 = F32::powf(2.0, 0.0833333358 * (self.fRec49[0] + -81.1100006));
			let mut fTemp108: F32 = F32::max(440.0 * fTemp107, 23.4489498);
			let mut fTemp109: F32 = F32::max(20.0, F32::abs(fTemp108));
			let mut fTemp110: F32 = self.fRec54[1] + self.fConst3 * fTemp109;
			self.fRec54[0] = fTemp110 - F32::floor(fTemp110);
			let mut fTemp111: F32 = mydsp_faustpower2_f(2.0 * self.fRec54[0] + -1.0);
			self.fVec5[0] = fTemp111;
			let mut fTemp112: F32 = (fTemp92 * (fTemp111 - self.fVec5[1])) / fTemp109;
			self.fVec6[(self.IOTA0 & 4095) as usize] = fTemp112;
			let mut fTemp113: F32 = F32::max(0.0, F32::min(2047.0, self.fConst7 / fTemp108));
			let mut iTemp114: i32 = ((fTemp113) as i32);
			let mut fTemp115: F32 = F32::floor(fTemp113);
			self.fRec53[0] = 0.999000013 * self.fRec53[1] - self.fConst6 * (self.fVec6[((self.IOTA0 - iTemp114) & 4095) as usize] * (fTemp115 + 1.0 - fTemp113) - fTemp112 + (fTemp113 - fTemp115) * self.fVec6[((self.IOTA0 - (iTemp114 + 1)) & 4095) as usize]);
			let mut fTemp116: F32 = F32::powf(2.0, 0.0833333358 * (self.fRec49[0] + -61.8800011));
			let mut fTemp117: F32 = F32::max(440.0 * fTemp116, 23.4489498);
			let mut fTemp118: F32 = F32::max(20.0, F32::abs(fTemp117));
			let mut fTemp119: F32 = self.fRec56[1] + self.fConst3 * fTemp118;
			self.fRec56[0] = fTemp119 - F32::floor(fTemp119);
			let mut fTemp120: F32 = mydsp_faustpower2_f(2.0 * self.fRec56[0] + -1.0);
			self.fVec7[0] = fTemp120;
			let mut fTemp121: F32 = (fTemp92 * (fTemp120 - self.fVec7[1])) / fTemp118;
			self.fVec8[(self.IOTA0 & 4095) as usize] = fTemp121;
			let mut fTemp122: F32 = F32::max(0.0, F32::min(2047.0, self.fConst7 / fTemp117));
			let mut iTemp123: i32 = ((fTemp122) as i32);
			let mut fTemp124: F32 = F32::floor(fTemp122);
			self.fRec55[0] = 0.999000013 * self.fRec55[1] - self.fConst6 * (self.fVec8[((self.IOTA0 - iTemp123) & 4095) as usize] * (fTemp124 + 1.0 - fTemp122) - fTemp121 + (fTemp122 - fTemp124) * self.fVec8[((self.IOTA0 - (iTemp123 + 1)) & 4095) as usize]);
			self.fRec59[0] = fSlow16 + self.fConst2 * self.fRec59[1];
			let mut fTemp125: F32 = F32::powf(2.0, 0.0833333358 * (self.fRec8[0] + self.fRec59[0] + -69.0));
			let mut fTemp126: F32 = 1.0 / F32::tan(self.fConst8 * fTemp125);
			let mut fRec70: F32 = -1.0 * 0.997305274 * (0.899999976 * self.fRec71[2] + 0.0500000007 * (self.fRec71[1] + self.fRec71[3]));
			let mut fTemp127: F32 = self.fConst10 * (0.772727251 / fTemp125 + -0.109999999);
			let mut fTemp128: F32 = fTemp127 + -1.49999499;
			let mut iTemp129: i32 = ((fTemp128) as i32);
			let mut iTemp130: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp129)) as F32))) as i32);
			let mut iTemp131: i32 = iTemp130 + 1;
			let mut fTemp132: F32 = F32::floor(fTemp128);
			let mut fTemp133: F32 = fTemp127 + -1.0 - fTemp132;
			let mut fTemp134: F32 = 0.0 - fTemp133;
			let mut fTemp135: F32 = fTemp127 + -2.0 - fTemp132;
			let mut fTemp136: F32 = 0.0 - 0.5 * fTemp135;
			let mut fTemp137: F32 = fTemp127 + -3.0 - fTemp132;
			let mut fTemp138: F32 = 0.0 - 0.333333343 * fTemp137;
			let mut fTemp139: F32 = fTemp127 + -4.0 - fTemp132;
			let mut fTemp140: F32 = 0.0 - 0.25 * fTemp139;
			let mut fTemp141: F32 = fTemp127 - fTemp132;
			let mut iTemp142: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp129 + 1)) as F32))) as i32);
			let mut iTemp143: i32 = iTemp142 + 1;
			let mut fTemp144: F32 = 0.0 - fTemp135;
			let mut fTemp145: F32 = 0.0 - 0.5 * fTemp137;
			let mut fTemp146: F32 = 0.0 - 0.333333343 * fTemp139;
			let mut iTemp147: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp129 + 2)) as F32))) as i32);
			let mut iTemp148: i32 = iTemp147 + 1;
			let mut fTemp149: F32 = 0.0 - fTemp137;
			let mut fTemp150: F32 = 0.0 - 0.5 * fTemp139;
			let mut fTemp151: F32 = fTemp133 * fTemp135;
			let mut iTemp152: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp129 + 3)) as F32))) as i32);
			let mut iTemp153: i32 = iTemp152 + 1;
			let mut fTemp154: F32 = 0.0 - fTemp139;
			let mut fTemp155: F32 = fTemp151 * fTemp137;
			let mut iTemp156: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp129 + 4)) as F32))) as i32);
			let mut iTemp157: i32 = iTemp156 + 1;
			self.fRec85[0] = self.fRec62[((self.IOTA0 - iTemp131) & 2047) as usize] * fTemp134 * fTemp136 * fTemp138 * fTemp140 + fTemp141 * (self.fRec62[((self.IOTA0 - iTemp143) & 2047) as usize] * fTemp144 * fTemp145 * fTemp146 + 0.5 * fTemp133 * self.fRec62[((self.IOTA0 - iTemp148) & 2047) as usize] * fTemp149 * fTemp150 + 0.166666672 * fTemp151 * self.fRec62[((self.IOTA0 - iTemp153) & 2047) as usize] * fTemp154 + 0.0416666679 * fTemp155 * self.fRec62[((self.IOTA0 - iTemp157) & 2047) as usize]);
			self.fRec89[0] = 0.0500000007 * self.fRec89[1] + 0.949999988 * self.fRec85[1];
			let mut fRec86: F32 = self.fRec89[0];
			let mut fTemp158: F32 = fTemp134 * fTemp136 * fTemp138 * fTemp140;
			...
			let mut fTemp159: F32 = fTemp144 * fTemp145 * fTemp146;
			let mut fTemp160: F32 = fTemp133 * fTemp149 * fTemp150;
			let mut fTemp161: F32 = fTemp151 * fTemp154;
			self.fVec9[0] = fTemp158 * self.fRec92[((self.IOTA0 - (iTemp130 + 2)) & 2047) as usize] + fTemp141 * (fTemp159 * self.fRec92[((self.IOTA0 - (iTemp142 + 2)) & 2047) as usize] + 0.5 * fTemp160 * self.fRec92[((self.IOTA0 - (iTemp147 + 2)) & 2047) as usize] + 0.166666672 * fTemp161 * self.fRec92[((self.IOTA0 - (iTemp152 + 2)) & 2047) as usize] + 0.0416666679 * fTemp155 * self.fRec92[((self.IOTA0 - (iTemp156 + 2)) & 2047) as usize]);
			self.iRec94[0] = 1103515245 * self.iRec94[1] + 12345;
			let mut fTemp162: F32 = F32::tan(self.fConst11 * fTemp125);
			let mut fTemp163: F32 = 1.0 / fTemp162;
			let mut fTemp164: F32 = (fTemp163 + 1.41421354) / fTemp162 + 1.0;
			self.fRec93[0] = 4.65661287e-10 * ((self.iRec94[0]) as F32) - (self.fRec93[2] * ((fTemp163 + -1.41421354) / fTemp162 + 1.0) + 2.0 * self.fRec93[1] * (1.0 - 1.0 / mydsp_faustpower2_f(fTemp162))) / fTemp164;
			...
			let mut fTemp165: F32 = ((self.iRec95[0]) as F32) / F32::max(1.0, self.fConst12 * mydsp_faustpower2_f(1.0 - 0.219999999 * fTemp125));
			let mut fTemp166: F32 = fSlow19 * ((self.fRec93[2] + self.fRec93[0] + 2.0 * self.fRec93[1]) * F32::max(0.0, F32::min(fTemp165, 2.0 - fTemp165))) / fTemp164;
			let mut fTemp167: F32 = self.fVec9[1] + fTemp166;
			self.fVec11[0] = fTemp167;
			self.fRec90[(self.IOTA0 & 2047) as usize] = 0.0500000007 * self.fRec90[((self.IOTA0 - 1) & 2047) as usize] + 0.949999988 * self.fVec11[2];
			let mut fRec87: F32 = fTemp158 * self.fRec90[((self.IOTA0 - iTemp130) & 2047) as usize] + fTemp141 * (fTemp159 * self.fRec90[((self.IOTA0 - iTemp142) & 2047) as usize] + 0.5 * fTemp160 * self.fRec90[((self.IOTA0 - iTemp147) & 2047) as usize] + 0.166666672 * fTemp161 * self.fRec90[((self.IOTA0 - iTemp152) & 2047) as usize] + 0.0416666679 * fTemp155 * self.fRec90[((self.IOTA0 - iTemp156) & 2047) as usize]);
			...
			let mut fRec78: F32 = fTemp166 + self.fRec77[1];
			let mut fRec79: F32 = fRec83;
			let mut fRec80: F32 = fRec84;
			self.fRec73[(self.IOTA0 & 2047) as usize] = fRec78;
			let mut fRec74: F32 = fTemp158 * self.fRec73[((self.IOTA0 - iTemp131) & 2047) as usize] + fTemp141 * (fTemp159 * self.fRec73[((self.IOTA0 - iTemp143) & 2047) as usize] + 0.5 * fTemp160 * self.fRec73[((self.IOTA0 - iTemp148) & 2047) as usize] + 0.166666672 * fTemp161 * self.fRec73[((self.IOTA0 - iTemp153) & 2047) as usize] + 0.0416666679 * fTemp155 * self.fRec73[((self.IOTA0 - iTemp157) & 2047) as usize]);
			...
			let mut fTemp168: F32 = F32::abs(fRec61);
			let mut fTemp169: F32 = if (((self.fRec97[1] > fTemp168) as i32) as i32 != 0) { self.fConst13 } else { 0.0 };
			self.fRec98[0] = self.fRec98[1] * fTemp169 + fTemp168 * (1.0 - fTemp169);
			self.fRec97[0] = self.fRec98[0];
			let mut fRec96: F32 = 0.0 - 0.949999988 * F32::max(20.0 * F32::log10(self.fRec97[0]) + 60.0, 0.0);
			let mut fTemp170: F32 = fSlow17 * fRec61 * F32::powf(10.0, 0.0500000007 * fRec96);
			self.fVec12[0] = fTemp170;
			self.fRec58[0] = 0.0 - (self.fRec58[1] * (1.0 - fTemp126) - (fTemp170 + self.fVec12[1])) / (fTemp126 + 1.0);
			...
			let mut fTemp171: F32 = F32::powf(2.0, 2.29999995 * self.fRec100[0]);
			let mut fTemp172: F32 = 1.0 - self.fConst14 * fTemp171 / F32::powf(2.0, 2.0 * (1.0 - self.fRec100[0]) + 1.0);
			self.fRec101[0] = 0.999000013 * self.fRec101[1] - 0.00200000009 * fTemp172 * F32::cos(self.fConst15 * fTemp171);
			self.fRec102[0] = 0.999000013 * self.fRec102[1] + 0.00100000005 * mydsp_faustpower2_f(fTemp172);
			self.fRec57[0] = self.fRec58[0] * self.fRec99[0] - (self.fRec101[0] * self.fRec57[1] + self.fRec102[0] * self.fRec57[2]);
			self.fRec0[(self.IOTA0 & 65535) as usize] = (0.5 * self.fRec1[0] * ((self.fRec2[0] * (self.fRec3[2] + self.fRec3[0] + 2.0 * self.fRec3[1])) / fTemp25 + (self.fRec17[0] * (self.fRec18[2] + self.fRec18[0] + 2.0 * self.fRec18[1])) / fTemp47 + (self.fRec27[0] * (self.fRec28[2] + self.fRec28[0] + 2.0 * self.fRec28[1])) / fTemp67 + (self.fRec37[0] * (self.fRec38[2] + self.fRec38[0] + 2.0 * self.fRec38[1])) / fTemp87) + self.fConst5 * self.fRec47[0] * (self.fRec48[0] * fTemp88 + self.fRec51[0] * fTemp98 + self.fRec53[0] * fTemp107 + self.fRec55[0] * fTemp116) + self.fRec57[0] + 0.300000012 * self.fRec0[((self.IOTA0 - self.iConst16) & 65535) as usize]) - self.fRec57[1];

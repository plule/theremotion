...
impl FaustDsp for mydsp {
	...
	fn compute(&mut self, count: i32, inputs: &[&[Self::T]], outputs: &mut[&mut[Self::T]]) {
		...
		for (output0, output1) in zipped_iterators {
			...
			let mut fTemp7: F32 = self.fRec10[1] + fTemp6;
			let mut fTemp8: F32 = fTemp7 + -1.0;
			let mut iTemp9: i32 = ((fTemp8 < 0.0) as i32);
			self.fRec10[0] = if (iTemp9 as i32 != 0) { fTemp7 } else { fTemp8 };
			let mut fThen3: F32 = self.fRec10[1] + fTemp6 + fTemp8 * (1.0 - self.fConst0 / fTemp5);
			let mut fRec11: F32 = if (iTemp9 as i32 != 0) { fTemp7 } else { fThen3 };
			let mut fTemp10: F32 = -69.0 - self.fRec12[0];
			let mut fTemp11: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (fTemp0 + fTemp10))));
			let mut fTemp12: F32 = self.fConst3 * fTemp11;
			let mut fTemp13: F32 = self.fRec13[1] + fTemp12;
			...
			let mut fThen5: F32 = self.fRec13[1] + fTemp12 + fTemp14 * (1.0 - self.fConst0 / fTemp11);
			...
			let mut fTemp18: F32 = 1.41421354 * fTemp16;
			let mut fTemp19: F32 = fTemp18 + 2.0;
			self.fRec16[0] = fSlow7 + self.fConst2 * self.fRec16[1];
			let mut fTemp20: F32 = F32::tan(self.fConst4 * F32::max(20.0, F32::min(10000.0, 440.0 * F32::powf(2.0, 0.0833333358 * (fTemp0 + self.fRec16[0] + -69.0)))));
			let mut fTemp21: F32 = 1.0 / fTemp20;
			let mut fTemp22: F32 = 1.0 - 1.0 / mydsp_faustpower2_f(fTemp20);
			let mut fTemp23: F32 = fTemp17 + (fTemp21 + fTemp19) / fTemp20 + 1.0;
			self.fRec4[0] = 2.0 * fRec6 + self.fRec9[0] * (0.0 - 2.0 * (1.0 - (fRec11 + fRec14))) + -1.0 - (self.fRec4[2] * (fTemp17 + 1.0 - (fTemp19 - fTemp21) / fTemp20) + 2.0 * self.fRec4[1] * (fTemp17 + fTemp22)) / fTemp23;
			let mut fTemp24: F32 = fTemp16 * (fTemp16 + -1.41421354);
			let mut fTemp25: F32 = 2.0 - fTemp18;
			let mut fTemp26: F32 = fTemp24 + (fTemp25 + fTemp21) / fTemp20 + 1.0;
			self.fRec3[0] = (self.fRec4[2] + self.fRec4[0] + 2.0 * self.fRec4[1]) / fTemp23 - (self.fRec3[2] * (fTemp24 + (fTemp21 - fTemp25) / fTemp20 + 1.0) + 2.0 * self.fRec3[1] * (fTemp24 + fTemp22)) / fTemp26;
			...
			let mut fTemp37: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (fTemp27 + fTemp10))));
			...
			let mut fTemp45: F32 = fTemp17 + (fTemp19 + fTemp43) / fTemp42 + 1.0;
			self.fRec19[0] = 2.0 * fRec21 + self.fRec9[0] * (0.0 - 2.0 * (1.0 - (fRec24 + fRec26))) + -1.0 - (self.fRec19[2] * (fTemp17 + (fTemp43 - fTemp19) / fTemp42 + 1.0) + 2.0 * self.fRec19[1] * (fTemp17 + fTemp44)) / fTemp45;
			let mut fTemp46: F32 = fTemp24 + (fTemp25 + fTemp43) / fTemp42 + 1.0;
			self.fRec18[0] = (self.fRec19[2] + self.fRec19[0] + 2.0 * self.fRec19[1]) / fTemp45 - (self.fRec18[2] * (fTemp24 + (fTemp43 - fTemp25) / fTemp42 + 1.0) + 2.0 * self.fRec18[1] * (fTemp24 + fTemp44)) / fTemp46;
			...
			let mut fTemp52: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (self.fRec32[0] + fTemp32 + -69.0))));
			...
			let mut fTemp56: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (fTemp47 + fTemp10))));
			...
			let mut fTemp63: F32 = fTemp17 + (fTemp19 + fTemp61) / fTemp60 + 1.0;
			self.fRec29[0] = 2.0 * fRec31 + self.fRec9[0] * (0.0 - 2.0 * (1.0 - (fRec34 + fRec36))) + -1.0 - (self.fRec29[2] * (fTemp17 + (fTemp61 - fTemp19) / fTemp60 + 1.0) + 2.0 * self.fRec29[1] * (fTemp17 + fTemp62)) / fTemp63;
			let mut fTemp64: F32 = fTemp24 + (fTemp25 + fTemp61) / fTemp60 + 1.0;
			self.fRec28[0] = (self.fRec29[2] + self.fRec29[0] + 2.0 * self.fRec29[1]) / fTemp63 - (self.fRec28[2] * (fTemp24 + (fTemp61 - fTemp25) / fTemp60 + 1.0) + 2.0 * self.fRec28[1] * (fTemp24 + fTemp62)) / fTemp64;
			...
			let mut fTemp67: F32 = self.fConst3 * fTemp66;
			let mut fTemp68: F32 = self.fRec40[1] + fTemp67;
			let mut fTemp69: F32 = fTemp68 + -1.0;
			let mut iTemp70: i32 = ((fTemp69 < 0.0) as i32);
			self.fRec40[0] = if (iTemp70 as i32 != 0) { fTemp68 } else { fTemp69 };
			let mut fThen19: F32 = fTemp67 + self.fRec40[1] + fTemp69 * (1.0 - self.fConst0 / fTemp66);
			let mut fRec41: F32 = if (iTemp70 as i32 != 0) { fTemp68 } else { fThen19 };
			let mut fTemp71: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (self.fRec42[0] + fTemp32 + -69.0))));
			let mut fTemp72: F32 = self.fRec43[1] + self.fConst3 * fTemp71;
			...
			let mut fThen21: F32 = fTemp72 + fTemp73 * (1.0 - self.fConst0 / fTemp71);
			let mut fRec44: F32 = if (iTemp74 as i32 != 0) { fTemp72 } else { fThen21 };
			let mut fTemp75: F32 = F32::max(1.1920929e-07, F32::abs(440.0 * F32::powf(2.0, 0.0833333358 * (fTemp65 + fTemp10))));
			let mut fTemp76: F32 = self.fConst3 * fTemp75;
			let mut fTemp77: F32 = self.fRec45[1] + fTemp76;
			let mut fTemp78: F32 = fTemp77 + -1.0;
			let mut iTemp79: i32 = ((fTemp78 < 0.0) as i32);
			self.fRec45[0] = if (iTemp79 as i32 != 0) { fTemp77 } else { fTemp78 };
			let mut fThen23: F32 = fTemp76 + self.fRec45[1] + fTemp78 * (1.0 - self.fConst0 / fTemp75);
			let mut fRec46: F32 = if (iTemp79 as i32 != 0) { fTemp77 } else { fThen23 };
			let mut fTemp80: F32 = F32::tan(self.fConst4 * F32::max(20.0, F32::min(10000.0, 440.0 * F32::powf(2.0, 0.0833333358 * (self.fRec42[0] + fTemp41 + -69.0)))));
			let mut fTemp81: F32 = 1.0 / fTemp80;
			let mut fTemp82: F32 = 1.0 - 1.0 / mydsp_faustpower2_f(fTemp80);
			let mut fTemp83: F32 = fTemp17 + (fTemp19 + fTemp81) / fTemp80 + 1.0;
			self.fRec39[0] = 2.0 * fRec41 + self.fRec9[0] * (0.0 - 2.0 * (1.0 - (fRec44 + fRec46))) + -1.0 - (self.fRec39[2] * (fTemp17 + 1.0 - (fTemp19 - fTemp81) / fTemp80) + 2.0 * self.fRec39[1] * (fTemp17 + fTemp82)) / fTemp83;
			let mut fTemp84: F32 = fTemp24 + (fTemp25 + fTemp81) / fTemp80 + 1.0;
			self.fRec38[0] = (self.fRec39[2] + self.fRec39[0] + 2.0 * self.fRec39[1]) / fTemp83 - (self.fRec38[2] * (fTemp24 + (fTemp81 - fTemp25) / fTemp80 + 1.0) + 2.0 * self.fRec38[1] * (fTemp24 + fTemp82)) / fTemp84;
			self.fRec47[0] = fSlow14 + self.fConst2 * self.fRec47[1];
			self.fRec49[0] = fSlow15 + self.fConst2 * self.fRec49[1];
			let mut fTemp85: F32 = F32::powf(2.0, 0.0833333358 * (self.fRec49[0] + -69.0));
			let mut fTemp86: F32 = F32::max(440.0 * fTemp85, 23.4489498);
			let mut fTemp87: F32 = F32::max(0.0, F32::min(2047.0, self.fConst7 / fTemp86));
			let mut fTemp88: F32 = F32::floor(fTemp87);
			let mut fTemp89: F32 = ((self.iVec0[1]) as F32);
			let mut fTemp90: F32 = F32::max(20.0, F32::abs(fTemp86));
			let mut fTemp91: F32 = self.fRec50[1] + self.fConst3 * fTemp90;
			self.fRec50[0] = fTemp91 - F32::floor(fTemp91);
			let mut fTemp92: F32 = mydsp_faustpower2_f(2.0 * self.fRec50[0] + -1.0);
			self.fVec1[0] = fTemp92;
			let mut fTemp93: F32 = (fTemp89 * (fTemp92 - self.fVec1[1])) / fTemp90;
			self.fVec2[(self.IOTA0 & 4095) as usize] = fTemp93;
			let mut iTemp94: i32 = ((fTemp87) as i32);
			self.fRec48[0] = 0.999000013 * self.fRec48[1] - self.fConst6 * ((fTemp87 - fTemp88) * self.fVec2[((self.IOTA0 - (iTemp94 + 1)) & 4095) as usize] - fTemp93 - self.fVec2[((self.IOTA0 - iTemp94) & 4095) as usize] * (fTemp88 + 1.0 - fTemp87));
			let mut fTemp95: F32 = F32::powf(2.0, 0.0833333358 * (self.fRec49[0] + -56.9000015));
			let mut fTemp96: F32 = F32::max(440.0 * fTemp95, 23.4489498);
			let mut fTemp97: F32 = F32::max(20.0, F32::abs(fTemp96));
			let mut fTemp98: F32 = self.fRec52[1] + self.fConst3 * fTemp97;
			self.fRec52[0] = fTemp98 - F32::floor(fTemp98);
			let mut fTemp99: F32 = mydsp_faustpower2_f(2.0 * self.fRec52[0] + -1.0);
			self.fVec3[0] = fTemp99;
			let mut fTemp100: F32 = (fTemp89 * (fTemp99 - self.fVec3[1])) / fTemp97;
			self.fVec4[(self.IOTA0 & 4095) as usize] = fTemp100;
			let mut fTemp101: F32 = F32::max(0.0, F32::min(2047.0, self.fConst7 / fTemp96));
			let mut iTemp102: i32 = ((fTemp101) as i32);
			let mut fTemp103: F32 = F32::floor(fTemp101);
			self.fRec51[0] = 0.999000013 * self.fRec51[1] + self.fConst6 * (fTemp100 - self.fVec4[((self.IOTA0 - iTemp102) & 4095) as usize] * (fTemp103 + 1.0 - fTemp101) - (fTemp101 - fTemp103) * self.fVec4[((self.IOTA0 - (iTemp102 + 1)) & 4095) as usize]);
			let mut fTemp104: F32 = F32::powf(2.0, 0.0833333358 * (self.fRec49[0] + -81.1100006));
			let mut fTemp105: F32 = F32::max(440.0 * fTemp104, 23.4489498);
			let mut fTemp106: F32 = F32::max(20.0, F32::abs(fTemp105));
			let mut fTemp107: F32 = self.fRec54[1] + self.fConst3 * fTemp106;
			self.fRec54[0] = fTemp107 - F32::floor(fTemp107);
			let mut fTemp108: F32 = mydsp_faustpower2_f(2.0 * self.fRec54[0] + -1.0);
			self.fVec5[0] = fTemp108;
			let mut fTemp109: F32 = (fTemp89 * (fTemp108 - self.fVec5[1])) / fTemp106;
			self.fVec6[(self.IOTA0 & 4095) as usize] = fTemp109;
			let mut fTemp110: F32 = F32::max(0.0, F32::min(2047.0, self.fConst7 / fTemp105));
			let mut iTemp111: i32 = ((fTemp110) as i32);
			let mut fTemp112: F32 = F32::floor(fTemp110);
			self.fRec53[0] = 0.999000013 * self.fRec53[1] - self.fConst6 * (self.fVec6[((self.IOTA0 - iTemp111) & 4095) as usize] * (fTemp112 + 1.0 - fTemp110) - fTemp109 + (fTemp110 - fTemp112) * self.fVec6[((self.IOTA0 - (iTemp111 + 1)) & 4095) as usize]);
			let mut fTemp113: F32 = F32::powf(2.0, 0.0833333358 * (self.fRec49[0] + -61.8800011));
			let mut fTemp114: F32 = F32::max(440.0 * fTemp113, 23.4489498);
			let mut fTemp115: F32 = F32::max(20.0, F32::abs(fTemp114));
			let mut fTemp116: F32 = self.fRec56[1] + self.fConst3 * fTemp115;
			self.fRec56[0] = fTemp116 - F32::floor(fTemp116);
			let mut fTemp117: F32 = mydsp_faustpower2_f(2.0 * self.fRec56[0] + -1.0);
			self.fVec7[0] = fTemp117;
			let mut fTemp118: F32 = (fTemp89 * (fTemp117 - self.fVec7[1])) / fTemp115;
			self.fVec8[(self.IOTA0 & 4095) as usize] = fTemp118;
			let mut fTemp119: F32 = F32::max(0.0, F32::min(2047.0, self.fConst7 / fTemp114));
			let mut iTemp120: i32 = ((fTemp119) as i32);
			let mut fTemp121: F32 = F32::floor(fTemp119);
			self.fRec55[0] = 0.999000013 * self.fRec55[1] - self.fConst6 * (self.fVec8[((self.IOTA0 - iTemp120) & 4095) as usize] * (fTemp121 + 1.0 - fTemp119) - fTemp118 + (fTemp119 - fTemp121) * self.fVec8[((self.IOTA0 - (iTemp120 + 1)) & 4095) as usize]);
			self.fRec59[0] = fSlow16 + self.fConst2 * self.fRec59[1];
			let mut fTemp122: F32 = F32::powf(2.0, 0.0833333358 * (self.fRec8[0] + self.fRec59[0] + -69.0));
			...
			let mut fTemp124: F32 = self.fConst10 * (0.772727251 / fTemp122 + -0.109999999);
			let mut fTemp125: F32 = fTemp124 + -1.49999499;
			let mut iTemp126: i32 = ((fTemp125) as i32);
			let mut iTemp127: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp126)) as F32))) as i32);
			let mut iTemp128: i32 = iTemp127 + 1;
			let mut fTemp129: F32 = F32::floor(fTemp125);
			let mut fTemp130: F32 = fTemp124 + -1.0 - fTemp129;
			let mut fTemp131: F32 = 0.0 - fTemp130;
			let mut fTemp132: F32 = fTemp124 + -2.0 - fTemp129;
			let mut fTemp133: F32 = 0.0 - 0.5 * fTemp132;
			let mut fTemp134: F32 = fTemp124 + -3.0 - fTemp129;
			let mut fTemp135: F32 = 0.0 - 0.333333343 * fTemp134;
			let mut fTemp136: F32 = fTemp124 + -4.0 - fTemp129;
			let mut fTemp137: F32 = 0.0 - 0.25 * fTemp136;
			let mut fTemp138: F32 = fTemp124 - fTemp129;
			let mut iTemp139: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp126 + 1)) as F32))) as i32);
			let mut iTemp140: i32 = iTemp139 + 1;
			let mut fTemp141: F32 = 0.0 - fTemp132;
			let mut fTemp142: F32 = 0.0 - 0.5 * fTemp134;
			let mut fTemp143: F32 = 0.0 - 0.333333343 * fTemp136;
			let mut iTemp144: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp126 + 2)) as F32))) as i32);
			let mut iTemp145: i32 = iTemp144 + 1;
			let mut fTemp146: F32 = 0.0 - fTemp134;
			let mut fTemp147: F32 = 0.0 - 0.5 * fTemp136;
			let mut fTemp148: F32 = fTemp130 * fTemp132;
			let mut iTemp149: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp126 + 3)) as F32))) as i32);
			let mut iTemp150: i32 = iTemp149 + 1;
			let mut fTemp151: F32 = 0.0 - fTemp136;
			let mut fTemp152: F32 = fTemp148 * fTemp134;
			let mut iTemp153: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp126 + 4)) as F32))) as i32);
			let mut iTemp154: i32 = iTemp153 + 1;
			self.fRec85[0] = self.fRec62[((self.IOTA0 - iTemp128) & 2047) as usize] * fTemp131 * fTemp133 * fTemp135 * fTemp137 + fTemp138 * (self.fRec62[((self.IOTA0 - iTemp140) & 2047) as usize] * fTemp141 * fTemp142 * fTemp143 + 0.5 * fTemp130 * self.fRec62[((self.IOTA0 - iTemp145) & 2047) as usize] * fTemp146 * fTemp147 + 0.166666672 * fTemp148 * self.fRec62[((self.IOTA0 - iTemp150) & 2047) as usize] * fTemp151 + 0.0416666679 * fTemp152 * self.fRec62[((self.IOTA0 - iTemp154) & 2047) as usize]);
			self.fRec89[0] = 0.0500000007 * self.fRec89[1] + 0.949999988 * self.fRec85[1];
			let mut fRec86: F32 = self.fRec89[0];
			let mut fTemp155: F32 = fTemp131 * fTemp133 * fTemp135 * fTemp137;
			...
			let mut fTemp156: F32 = fTemp141 * fTemp142 * fTemp143;
			let mut fTemp157: F32 = fTemp130 * fTemp146 * fTemp147;
			let mut fTemp158: F32 = fTemp148 * fTemp151;
			self.fVec9[0] = fTemp155 * self.fRec92[((self.IOTA0 - (iTemp127 + 2)) & 2047) as usize] + fTemp138 * (fTemp156 * self.fRec92[((self.IOTA0 - (iTemp139 + 2)) & 2047) as usize] + 0.5 * fTemp157 * self.fRec92[((self.IOTA0 - (iTemp144 + 2)) & 2047) as usize] + 0.166666672 * fTemp158 * self.fRec92[((self.IOTA0 - (iTemp149 + 2)) & 2047) as usize] + 0.0416666679 * fTemp152 * self.fRec92[((self.IOTA0 - (iTemp153 + 2)) & 2047) as usize]);
			self.iRec94[0] = 1103515245 * self.iRec94[1] + 12345;
			let mut fTemp159: F32 = F32::tan(self.fConst11 * fTemp122);
			let mut fTemp160: F32 = 1.0 / fTemp159;
			let mut fTemp161: F32 = (fTemp160 + 1.41421354) / fTemp159 + 1.0;
			self.fRec93[0] = 4.65661287e-10 * ((self.iRec94[0]) as F32) - (self.fRec93[2] * ((fTemp160 + -1.41421354) / fTemp159 + 1.0) + 2.0 * self.fRec93[1] * (1.0 - 1.0 / mydsp_faustpower2_f(fTemp159))) / fTemp161;
			...
			let mut fTemp162: F32 = ((self.iRec95[0]) as F32) / F32::max(1.0, self.fConst12 * mydsp_faustpower2_f(1.0 - 0.219999999 * fTemp122));
			let mut fTemp163: F32 = fSlow19 * ((self.fRec93[2] + self.fRec93[0] + 2.0 * self.fRec93[1]) * F32::max(0.0, F32::min(fTemp162, 2.0 - fTemp162))) / fTemp161;
			let mut fTemp164: F32 = self.fVec9[1] + fTemp163;
			self.fVec11[0] = fTemp164;
			self.fRec90[(self.IOTA0 & 2047) as usize] = 0.0500000007 * self.fRec90[((self.IOTA0 - 1) & 2047) as usize] + 0.949999988 * self.fVec11[2];
			let mut fRec87: F32 = fTemp155 * self.fRec90[((self.IOTA0 - iTemp127) & 2047) as usize] + fTemp138 * (fTemp156 * self.fRec90[((self.IOTA0 - iTemp139) & 2047) as usize] + 0.5 * fTemp157 * self.fRec90[((self.IOTA0 - iTemp144) & 2047) as usize] + 0.166666672 * fTemp158 * self.fRec90[((self.IOTA0 - iTemp149) & 2047) as usize] + 0.0416666679 * fTemp152 * self.fRec90[((self.IOTA0 - iTemp153) & 2047) as usize]);
			...
			let mut fRec78: F32 = fTemp163 + self.fRec77[1];
			let mut fRec79: F32 = fRec83;
			let mut fRec80: F32 = fRec84;
			self.fRec73[(self.IOTA0 & 2047) as usize] = fRec78;
			let mut fRec74: F32 = fTemp155 * self.fRec73[((self.IOTA0 - iTemp128) & 2047) as usize] + fTemp138 * (fTemp156 * self.fRec73[((self.IOTA0 - iTemp140) & 2047) as usize] + 0.5 * fTemp157 * self.fRec73[((self.IOTA0 - iTemp145) & 2047) as usize] + 0.166666672 * fTemp158 * self.fRec73[((self.IOTA0 - iTemp150) & 2047) as usize] + 0.0416666679 * fTemp152 * self.fRec73[((self.IOTA0 - iTemp154) & 2047) as usize]);
			...
			let mut fTemp165: F32 = F32::abs(fRec61);
			let mut fTemp166: F32 = if (((self.fRec97[1] > fTemp165) as i32) as i32 != 0) { self.fConst13 } else { 0.0 };
			self.fRec98[0] = self.fRec98[1] * fTemp166 + fTemp165 * (1.0 - fTemp166);
			self.fRec97[0] = self.fRec98[0];
			let mut fRec96: F32 = 0.0 - 0.949999988 * F32::max(20.0 * F32::log10(self.fRec97[0]) + 60.0, 0.0);
			let mut fTemp167: F32 = fSlow17 * fRec61 * F32::powf(10.0, 0.0500000007 * fRec96);
			self.fVec12[0] = fTemp167;
			self.fRec58[0] = 0.0 - (self.fRec58[1] * (1.0 - fTemp123) - (fTemp167 + self.fVec12[1])) / (fTemp123 + 1.0);
			...
			let mut fTemp168: F32 = F32::powf(2.0, 2.29999995 * self.fRec100[0]);
			let mut fTemp169: F32 = 1.0 - self.fConst14 * fTemp168 / F32::powf(2.0, 2.0 * (1.0 - self.fRec100[0]) + 1.0);
			self.fRec101[0] = 0.999000013 * self.fRec101[1] - 0.00200000009 * fTemp169 * F32::cos(self.fConst15 * fTemp168);
			self.fRec102[0] = 0.999000013 * self.fRec102[1] + 0.00100000005 * mydsp_faustpower2_f(fTemp169);
			self.fRec57[0] = self.fRec58[0] * self.fRec99[0] - (self.fRec101[0] * self.fRec57[1] + self.fRec102[0] * self.fRec57[2]);
			self.fRec0[(self.IOTA0 & 65535) as usize] = (0.5 * self.fRec1[0] * ((self.fRec2[0] * (self.fRec3[2] + self.fRec3[0] + 2.0 * self.fRec3[1])) / fTemp26 + (self.fRec17[0] * (self.fRec18[2] + self.fRec18[0] + 2.0 * self.fRec18[1])) / fTemp46 + (self.fRec27[0] * (self.fRec28[2] + self.fRec28[0] + 2.0 * self.fRec28[1])) / fTemp64 + (self.fRec37[0] * (self.fRec38[2] + self.fRec38[0] + 2.0 * self.fRec38[1])) / fTemp84) + self.fConst5 * self.fRec47[0] * (self.fRec48[0] * fTemp85 + self.fRec51[0] * fTemp95 + self.fRec53[0] * fTemp104 + self.fRec55[0] * fTemp113) + self.fRec57[0] + 0.300000012 * self.fRec0[((self.IOTA0 - self.iConst16) & 65535) as usize]) - self.fRec57[1];
			let mut fTemp170: F32 = self.fRec0[(self.IOTA0 & 65535) as usize];
			*output0 = ((fTemp170) as F32);
			*output1 = ((fTemp170) as F32);

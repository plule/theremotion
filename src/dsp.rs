...
impl FaustDsp for mydsp {
	...
	fn compute(&mut self, count: i32, inputs: &[&[Self::T]], outputs: &mut[&mut[Self::T]]) {
		...
		for (output0, output1) in zipped_iterators {
			...
			self.fRec5[0] = 0.999000013 * self.fRec5[1] - self.fConst4 * (self.fVec4[((self.IOTA0 - iTemp17) & 4095) as usize] * (fTemp18 + 1.0 - fTemp16) - fTemp15 + (fTemp16 - fTemp18) * self.fVec4[((self.IOTA0 - (iTemp17 + 1)) & 4095) as usize]);
			...
			let mut fThen1: F32 = fTemp39 + self.fRec14[1] + fTemp41 * (1.0 - self.fConst0 / fTemp38);
			...
			let mut fThen3: F32 = self.fRec18[1] + fTemp44 + fTemp46 * (1.0 - self.fConst0 / fTemp43);
			...
			let mut fTemp53: F32 = F32::powf(2.0, 0.0833333358 * (self.fRec16[0] + -81.0));
			let mut fTemp54: F32 = F32::max(440.0 * fTemp53, 23.4489498);
			let mut fTemp55: F32 = F32::max(0.0, F32::min(2047.0, self.fConst6 / fTemp54));
			let mut fTemp56: F32 = F32::floor(fTemp55);
			let mut fTemp57: F32 = F32::max(20.0, F32::abs(fTemp54));
			let mut fTemp58: F32 = self.fRec24[1] + self.fConst5 * fTemp57;
			self.fRec24[0] = fTemp58 - F32::floor(fTemp58);
			let mut fTemp59: F32 = mydsp_faustpower2_f(2.0 * self.fRec24[0] + -1.0);
			self.fVec9[0] = fTemp59;
			let mut fTemp60: F32 = (fTemp0 * (fTemp59 - self.fVec9[1])) / fTemp57;
			self.fVec10[(self.IOTA0 & 4095) as usize] = fTemp60;
			let mut iTemp61: i32 = ((fTemp55) as i32);
			self.fRec25[0] = fSlow7 + self.fConst3 * self.fRec25[1];
			let mut fTemp62: F32 = F32::min(1.41419947, 1.41421354 * self.fRec25[0]);
			let mut fTemp63: F32 = fTemp62 * (fTemp62 + 1.41421354);
			self.fRec26[0] = fSlow8 + self.fConst3 * self.fRec26[1];
			let mut fTemp64: F32 = F32::tan(self.fConst8 * F32::max(20.0, F32::min(10000.0, 440.0 * F32::powf(2.0, 0.0833333358 * (self.fRec16[0] + self.fRec26[0] + -69.0)))));
			let mut fTemp65: F32 = 1.0 / fTemp64;
			let mut fTemp66: F32 = 1.41421354 * fTemp62;
			let mut fTemp67: F32 = fTemp66 + 2.0;
			let mut fTemp68: F32 = 1.0 - 1.0 / mydsp_faustpower2_f(fTemp64);
			let mut fTemp69: F32 = fTemp63 + (fTemp65 + fTemp67) / fTemp64 + 1.0;
			self.fRec13[0] = 2.0 * fRec15 + self.fRec17[0] * (0.0 - 2.0 * (1.0 - (fRec19 + fRec22))) + self.fRec23[0] * (0.0 - self.fConst4 * ((fTemp55 - fTemp56) * self.fVec10[((self.IOTA0 - (iTemp61 + 1)) & 4095) as usize] - fTemp60 - self.fVec10[((self.IOTA0 - iTemp61) & 4095) as usize] * (fTemp56 + 1.0 - fTemp55))) + -1.0 - (self.fRec13[2] * (fTemp63 + (fTemp65 - fTemp67) / fTemp64 + 1.0) + 2.0 * self.fRec13[1] * (fTemp63 + fTemp68)) / fTemp69;
			let mut fTemp70: F32 = fTemp62 * (fTemp62 + -1.41421354);
			let mut fTemp71: F32 = 2.0 - fTemp66;
			let mut fTemp72: F32 = fTemp70 + (fTemp71 + fTemp65) / fTemp64 + 1.0;
			self.fRec12[0] = (self.fRec13[2] + self.fRec13[0] + 2.0 * self.fRec13[1]) / fTemp69 - (self.fRec12[2] * (fTemp70 + (fTemp65 - fTemp71) / fTemp64 + 1.0) + 2.0 * self.fRec12[1] * (fTemp70 + fTemp68)) / fTemp72;
			self.fRec0[(self.IOTA0 & 65535) as usize] = self.fConst1 * self.fRec1[0] * (self.fRec2[0] * fTemp1 + self.fRec5[0] * fTemp10 + self.fRec7[0] * fTemp19 + self.fRec9[0] * fTemp28) + 0.300000012 * self.fRec0[((self.IOTA0 - self.iConst7) & 65535) as usize] + (self.fRec11[0] * (self.fRec12[2] + self.fRec12[0] + 2.0 * self.fRec12[1])) / fTemp72;
			self.iRec37[0] = 0;
			...
			let mut fTemp73: F32 = 0.772727251 / fTemp53 + -0.100000001;
			let mut fTemp74: F32 = self.fConst10 * (1.0 - self.fRec52[0]) * fTemp73;
			let mut fTemp75: F32 = fTemp74 + -1.49999499;
			let mut iTemp76: i32 = ((fTemp75) as i32);
			let mut iTemp77: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp76)) as F32))) as i32);
			let mut fTemp78: F32 = F32::floor(fTemp75);
			let mut fTemp79: F32 = fTemp74 + -1.0 - fTemp78;
			let mut fTemp80: F32 = 0.0 - fTemp79;
			let mut fTemp81: F32 = fTemp74 + -2.0 - fTemp78;
			let mut fTemp82: F32 = 0.0 - 0.5 * fTemp81;
			let mut fTemp83: F32 = fTemp74 + -3.0 - fTemp78;
			let mut fTemp84: F32 = 0.0 - 0.333333343 * fTemp83;
			let mut fTemp85: F32 = fTemp74 + -4.0 - fTemp78;
			let mut fTemp86: F32 = 0.0 - 0.25 * fTemp85;
			let mut fTemp87: F32 = fTemp74 - fTemp78;
			let mut iTemp88: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp76 + 1)) as F32))) as i32);
			let mut fTemp89: F32 = 0.0 - fTemp81;
			let mut fTemp90: F32 = 0.0 - 0.5 * fTemp83;
			let mut fTemp91: F32 = 0.0 - 0.333333343 * fTemp85;
			let mut iTemp92: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp76 + 2)) as F32))) as i32);
			let mut fTemp93: F32 = 0.0 - fTemp83;
			let mut fTemp94: F32 = 0.0 - 0.5 * fTemp85;
			let mut fTemp95: F32 = fTemp79 * fTemp81;
			let mut iTemp96: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp76 + 3)) as F32))) as i32);
			let mut fTemp97: F32 = 0.0 - fTemp85;
			let mut fTemp98: F32 = fTemp95 * fTemp83;
			let mut iTemp99: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp76 + 4)) as F32))) as i32);
			self.fRec49[0] = self.fRec29[((self.IOTA0 - (iTemp77 + 1)) & 2047) as usize] * fTemp80 * fTemp82 * fTemp84 * fTemp86 + fTemp87 * (self.fRec29[((self.IOTA0 - (iTemp88 + 1)) & 2047) as usize] * fTemp89 * fTemp90 * fTemp91 + 0.5 * fTemp79 * self.fRec29[((self.IOTA0 - (iTemp92 + 1)) & 2047) as usize] * fTemp93 * fTemp94 + 0.166666672 * fTemp95 * self.fRec29[((self.IOTA0 - (iTemp96 + 1)) & 2047) as usize] * fTemp97 + 0.0416666679 * fTemp98 * self.fRec29[((self.IOTA0 - (iTemp99 + 1)) & 2047) as usize]);
			...
			let mut fTemp100: F32 = self.fConst10 * self.fRec52[0] * fTemp73;
			let mut fTemp101: F32 = fTemp100 + -1.49999499;
			let mut iTemp102: i32 = ((fTemp101) as i32);
			let mut iTemp103: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp102)) as F32))) as i32);
			let mut fTemp104: F32 = F32::floor(fTemp101);
			let mut fTemp105: F32 = fTemp100 + -1.0 - fTemp104;
			let mut fTemp106: F32 = 0.0 - fTemp105;
			let mut fTemp107: F32 = fTemp100 + -2.0 - fTemp104;
			let mut fTemp108: F32 = 0.0 - 0.5 * fTemp107;
			let mut fTemp109: F32 = fTemp100 + -3.0 - fTemp104;
			let mut fTemp110: F32 = 0.0 - 0.333333343 * fTemp109;
			let mut fTemp111: F32 = fTemp100 + -4.0 - fTemp104;
			let mut fTemp112: F32 = 0.0 - 0.25 * fTemp111;
			let mut fTemp113: F32 = fTemp100 - fTemp104;
			let mut iTemp114: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp102 + 1)) as F32))) as i32);
			let mut fTemp115: F32 = 0.0 - fTemp107;
			let mut fTemp116: F32 = 0.0 - 0.5 * fTemp109;
			let mut fTemp117: F32 = 0.0 - 0.333333343 * fTemp111;
			let mut iTemp118: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp102 + 2)) as F32))) as i32);
			let mut fTemp119: F32 = 0.0 - fTemp109;
			let mut fTemp120: F32 = 0.0 - 0.5 * fTemp111;
			let mut fTemp121: F32 = fTemp105 * fTemp107;
			let mut iTemp122: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp102 + 3)) as F32))) as i32);
			let mut fTemp123: F32 = 0.0 - fTemp111;
			let mut fTemp124: F32 = fTemp121 * fTemp109;
			let mut iTemp125: i32 = ((F32::min(self.fConst9, ((std::cmp::max(0, iTemp102 + 4)) as F32))) as i32);
			self.fVec11[0] = self.fRec56[((self.IOTA0 - (iTemp103 + 2)) & 2047) as usize] * fTemp106 * fTemp108 * fTemp110 * fTemp112 + fTemp113 * (self.fRec56[((self.IOTA0 - (iTemp114 + 2)) & 2047) as usize] * fTemp115 * fTemp116 * fTemp117 + 0.5 * fTemp105 * self.fRec56[((self.IOTA0 - (iTemp118 + 2)) & 2047) as usize] * fTemp119 * fTemp120 + 0.166666672 * fTemp121 * self.fRec56[((self.IOTA0 - (iTemp122 + 2)) & 2047) as usize] * fTemp123 + 0.0416666679 * fTemp124 * self.fRec56[((self.IOTA0 - (iTemp125 + 2)) & 2047) as usize]);
			self.iRec58[0] = 1103515245 * self.iRec58[1] + 12345;
			let mut fTemp126: F32 = F32::tan(self.fConst11 * fTemp53);
			let mut fTemp127: F32 = 1.0 / fTemp126;
			let mut fTemp128: F32 = (fTemp127 + 1.41421354) / fTemp126 + 1.0;
			self.fRec57[0] = 4.65661287e-10 * ((self.iRec58[0]) as F32) - (self.fRec57[2] * ((fTemp127 + -1.41421354) / fTemp126 + 1.0) + 2.0 * self.fRec57[1] * (1.0 - 1.0 / mydsp_faustpower2_f(fTemp126))) / fTemp128;
			...
			let mut fTemp129: F32 = ((self.iRec59[0]) as F32) / F32::max(1.0, self.fConst12 * mydsp_faustpower2_f(1.0 - 0.146666661 * fTemp53));
			let mut fTemp130: F32 = ((self.fRec57[2] + self.fRec57[0] + 2.0 * self.fRec57[1]) * F32::max(0.0, F32::min(fTemp129, 2.0 - fTemp129))) / fTemp128;
			self.fVec13[0] = self.fVec11[1] + fTemp130;
			self.fRec54[(self.IOTA0 & 2047) as usize] = 0.0500000007 * self.fRec54[((self.IOTA0 - 1) & 2047) as usize] + 0.949999988 * self.fVec13[1];
			let mut fRec51: F32 = fTemp80 * fTemp82 * fTemp84 * fTemp86 * self.fRec54[((self.IOTA0 - iTemp77) & 2047) as usize] + fTemp87 * (fTemp89 * fTemp90 * fTemp91 * self.fRec54[((self.IOTA0 - iTemp88) & 2047) as usize] + 0.5 * fTemp79 * fTemp93 * fTemp94 * self.fRec54[((self.IOTA0 - iTemp92) & 2047) as usize] + 0.166666672 * fTemp95 * fTemp97 * self.fRec54[((self.IOTA0 - iTemp96) & 2047) as usize] + 0.0416666679 * fTemp98 * self.fRec54[((self.IOTA0 - iTemp99) & 2047) as usize]);
			self.fRec46[0] = fRec50;
			let mut fRec47: F32 = fTemp130 + self.fRec46[1];
			let mut fRec48: F32 = fRec51;
			self.fRec43[(self.IOTA0 & 2047) as usize] = fRec47;
			let mut fRec44: F32 = fTemp106 * fTemp108 * fTemp110 * fTemp112 * self.fRec43[((self.IOTA0 - (iTemp103 + 1)) & 2047) as usize] + fTemp113 * (fTemp115 * fTemp116 * fTemp117 * self.fRec43[((self.IOTA0 - (iTemp114 + 1)) & 2047) as usize] + 0.5 * fTemp105 * fTemp119 * fTemp120 * self.fRec43[((self.IOTA0 - (iTemp118 + 1)) & 2047) as usize] + 0.166666672 * fTemp121 * fTemp123 * self.fRec43[((self.IOTA0 - (iTemp122 + 1)) & 2047) as usize] + 0.0416666679 * fTemp124 * self.fRec43[((self.IOTA0 - (iTemp125 + 1)) & 2047) as usize]);
			...
			let mut fTemp131: F32 = self.fRec0[(self.IOTA0 & 65535) as usize] + fRec28;

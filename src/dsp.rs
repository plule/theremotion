...
impl FaustDsp for mydsp {
	...
	fn compute(&mut self, count: i32, inputs: &[&[Self::T]], outputs: &mut[&mut[Self::T]]) {
		...
		for (output0, output1) in zipped_iterators {
			...
			self.fRec241[0] = self.fRec245[0] * (2.0 * fRec243 + -1.0) - (self.fRec241[2] * (fTemp258 + (1.0 - (fTemp257 - fTemp252) / fTemp251)) + 2.0 * self.fRec241[1] * (fTemp258 + (1.0 - fTemp256))) / fTemp259;
			...
			let mut fThen17: F32 = self.fRec249[1] + fTemp271 + (1.0 - self.fConst0 / fTemp270) * fTemp273;
			let mut fRec250: F32 = if (iTemp274 as i32 != 0) { fTemp272 } else { fThen17 };
			self.fRec252[0] = fSlow24 + self.fConst2 * self.fRec252[1];
			self.fRec248[0] = self.fRec252[0] * (2.0 * fRec250 + -1.0) - (self.fRec248[2] * (fTemp258 + (fTemp266 - fTemp257) / fTemp265 + 1.0) + 2.0 * self.fRec248[1] * (fTemp258 + (1.0 - fTemp268))) / fTemp269;
			...
			let mut fTemp281: F32 = self.fConst15 * fTemp280;
			let mut fTemp282: F32 = self.fRec256[1] + fTemp281;
			let mut fTemp283: F32 = fTemp282 + -1.0;
			let mut iTemp284: i32 = ((fTemp283 < 0.0) as i32);
			self.fRec256[0] = if (iTemp284 as i32 != 0) { fTemp282 } else { fTemp283 };
			let mut fThen19: F32 = fTemp281 + self.fRec256[1] + (1.0 - self.fConst0 / fTemp280) * fTemp283;
			let mut fRec257: F32 = if (iTemp284 as i32 != 0) { fTemp282 } else { fThen19 };
			...
			let mut fTemp285: F32 = F32::tan(self.fConst14 * F32::max(2e+01, F32::min(1e+04, self.fRec260[0])));
			let mut fTemp286: F32 = 1.0 / fTemp285;
			let mut fTemp287: F32 = fTemp254 + (fTemp253 + fTemp286) / fTemp285 + fTemp249;
			let mut fTemp288: F32 = 1.0 / mydsp_faustpower2_f(fTemp285);
			let mut fTemp289: F32 = fTemp258 + (fTemp286 + fTemp257) / fTemp285 + 1.0;
			self.fRec265[0] = fSlow29 + self.fConst2 * self.fRec265[1];
			let mut fTemp290: F32 = F32::max(1.1920929e-07, F32::abs(self.fRec265[0]));
			let mut fTemp291: F32 = self.fRec263[1] + self.fConst15 * fTemp290;
			let mut fTemp292: F32 = fTemp291 + -1.0;
			let mut iTemp293: i32 = ((fTemp292 < 0.0) as i32);
			self.fRec263[0] = if (iTemp293 as i32 != 0) { fTemp291 } else { fTemp292 };
			let mut fThen21: F32 = fTemp291 + (1.0 - self.fConst0 / fTemp290) * fTemp292;
			let mut fRec264: F32 = if (iTemp293 as i32 != 0) { fTemp291 } else { fThen21 };
			self.fRec266[0] = fSlow30 + self.fConst2 * self.fRec266[1];
			self.fRec262[0] = self.fRec266[0] * (2.0 * fRec264 + -1.0) - (self.fRec262[2] * (fTemp258 + (1.0 - (fTemp257 - fTemp286) / fTemp285)) + 2.0 * self.fRec262[1] * (fTemp258 + (1.0 - fTemp288))) / fTemp289;
			self.fRec261[0] = (self.fRec262[2] + self.fRec262[0] + 2.0 * self.fRec262[1]) / fTemp289 - (self.fRec261[2] * (fTemp254 + (fTemp286 - fTemp253) / fTemp285 + fTemp249) + 2.0 * self.fRec261[1] * (fTemp254 + (1.0 - (fTemp248 + fTemp288)))) / fTemp287;
			self.fRec267[0] = fSlow31 + self.fConst2 * self.fRec267[1];
			self.fRec268[0] = fSlow32 + self.fConst2 * self.fRec268[1];
			let mut fTemp294: F32 = self.fRec268[0] * self.fRec267[0] * ((self.fRec261[2] + self.fRec261[0] + 2.0 * self.fRec261[1]) / fTemp287 + (self.fRec254[2] + self.fRec254[0] + 2.0 * self.fRec254[1]) / fTemp277 + (self.fRec247[2] + self.fRec247[0] + 2.0 * self.fRec247[1]) / fTemp267 + (self.fRec240[2] + self.fRec240[0] + 2.0 * self.fRec240[1]) / fTemp255);
			self.fRec269[0] = fSlow33 + self.fConst2 * self.fRec269[1];
			let mut fTemp295: F32 = F32::powf(2.0, 0.083333336 * (self.fRec269[0] + -61.88));
			let mut fTemp296: F32 = F32::max(4.4e+02 * fTemp295, 23.44895);
			let mut fTemp297: F32 = F32::max(2e+01, F32::abs(fTemp296));
			let mut fTemp298: F32 = self.fRec271[1] + self.fConst15 * fTemp297;
			self.fRec271[0] = fTemp298 - F32::floor(fTemp298);
			let mut fTemp299: F32 = mydsp_faustpower2_f(2.0 * self.fRec271[0] + -1.0);
			self.fVec21[0] = fTemp299;
			let mut fTemp300: F32 = ((self.iVec1[1]) as F32);
			let mut fTemp301: F32 = fTemp300 * (fTemp299 - self.fVec21[1]) / fTemp297;
			self.fVec22[(self.IOTA0 & 4095) as usize] = fTemp301;
			let mut fTemp302: F32 = F32::max(0.0, F32::min(2047.0, self.fConst16 / fTemp296));
			let mut iTemp303: i32 = ((fTemp302) as i32);
			let mut fTemp304: F32 = F32::floor(fTemp302);
			self.fRec270[0] = 0.999 * self.fRec270[1] - self.fConst17 * (self.fVec22[((i32::wrapping_sub(self.IOTA0, iTemp303)) & 4095) as usize] * (fTemp304 + (1.0 - fTemp302)) - fTemp301 + (fTemp302 - fTemp304) * self.fVec22[((i32::wrapping_sub(self.IOTA0, i32::wrapping_add(iTemp303, 1))) & 4095) as usize]);
			let mut fTemp305: F32 = F32::powf(2.0, 0.083333336 * (self.fRec269[0] + -81.11));
			let mut fTemp306: F32 = F32::max(4.4e+02 * fTemp305, 23.44895);
			let mut fTemp307: F32 = F32::max(2e+01, F32::abs(fTemp306));
			let mut fTemp308: F32 = self.fRec273[1] + self.fConst15 * fTemp307;
			self.fRec273[0] = fTemp308 - F32::floor(fTemp308);
			let mut fTemp309: F32 = mydsp_faustpower2_f(2.0 * self.fRec273[0] + -1.0);
			self.fVec23[0] = fTemp309;
			let mut fTemp310: F32 = fTemp300 * (fTemp309 - self.fVec23[1]) / fTemp307;
			self.fVec24[(self.IOTA0 & 4095) as usize] = fTemp310;
			let mut fTemp311: F32 = F32::max(0.0, F32::min(2047.0, self.fConst16 / fTemp306));
			let mut iTemp312: i32 = ((fTemp311) as i32);
			let mut fTemp313: F32 = F32::floor(fTemp311);
			self.fRec272[0] = 0.999 * self.fRec272[1] + self.fConst17 * (fTemp310 - self.fVec24[((i32::wrapping_sub(self.IOTA0, iTemp312)) & 4095) as usize] * (fTemp313 + (1.0 - fTemp311)) - (fTemp311 - fTemp313) * self.fVec24[((i32::wrapping_sub(self.IOTA0, i32::wrapping_add(iTemp312, 1))) & 4095) as usize]);
			let mut fTemp314: F32 = F32::powf(2.0, 0.083333336 * (self.fRec269[0] + -56.9));
			let mut fTemp315: F32 = F32::max(4.4e+02 * fTemp314, 23.44895);
			let mut fTemp316: F32 = F32::max(0.0, F32::min(2047.0, self.fConst16 / fTemp315));
			let mut fTemp317: F32 = F32::floor(fTemp316);
			let mut fTemp318: F32 = F32::max(2e+01, F32::abs(fTemp315));
			let mut fTemp319: F32 = self.fRec275[1] + self.fConst15 * fTemp318;
			self.fRec275[0] = fTemp319 - F32::floor(fTemp319);
			let mut fTemp320: F32 = mydsp_faustpower2_f(2.0 * self.fRec275[0] + -1.0);
			self.fVec25[0] = fTemp320;
			let mut fTemp321: F32 = fTemp300 * (fTemp320 - self.fVec25[1]) / fTemp318;
			self.fVec26[(self.IOTA0 & 4095) as usize] = fTemp321;
			let mut iTemp322: i32 = ((fTemp316) as i32);
			self.fRec274[0] = 0.999 * self.fRec274[1] - self.fConst17 * ((fTemp316 - fTemp317) * self.fVec26[((i32::wrapping_sub(self.IOTA0, i32::wrapping_add(iTemp322, 1))) & 4095) as usize] - (fTemp321 - self.fVec26[((i32::wrapping_sub(self.IOTA0, iTemp322)) & 4095) as usize] * (fTemp317 + (1.0 - fTemp316))));
			let mut fTemp323: F32 = F32::powf(2.0, 0.083333336 * (self.fRec269[0] + -69.0));
			let mut fTemp324: F32 = F32::max(4.4e+02 * fTemp323, 23.44895);
			let mut fTemp325: F32 = F32::max(2e+01, F32::abs(fTemp324));
			let mut fTemp326: F32 = self.fRec277[1] + self.fConst15 * fTemp325;
			self.fRec277[0] = fTemp326 - F32::floor(fTemp326);
			let mut fTemp327: F32 = mydsp_faustpower2_f(2.0 * self.fRec277[0] + -1.0);
			self.fVec27[0] = fTemp327;
			let mut fTemp328: F32 = fTemp300 * (fTemp327 - self.fVec27[1]) / fTemp325;
			self.fVec28[(self.IOTA0 & 4095) as usize] = fTemp328;
			let mut fTemp329: F32 = F32::max(0.0, F32::min(2047.0, self.fConst16 / fTemp324));
			let mut iTemp330: i32 = ((fTemp329) as i32);
			let mut fTemp331: F32 = F32::floor(fTemp329);
			self.fRec276[0] = 0.999 * self.fRec276[1] - self.fConst17 * (self.fVec28[((i32::wrapping_sub(self.IOTA0, iTemp330)) & 4095) as usize] * (fTemp331 + (1.0 - fTemp329)) - fTemp328 + (fTemp329 - fTemp331) * self.fVec28[((i32::wrapping_sub(self.IOTA0, i32::wrapping_add(iTemp330, 1))) & 4095) as usize]);
			self.fRec278[0] = fSlow34 + self.fConst2 * self.fRec278[1];
			self.fRec279[0] = fSlow35 + self.fConst2 * self.fRec279[1];
			let mut fTemp332: F32 = self.fConst18 * self.fRec279[0] * self.fRec278[0] * (self.fRec276[0] * fTemp323 + self.fRec274[0] * fTemp314 + self.fRec272[0] * fTemp305 + self.fRec270[0] * fTemp295);
			self.fRec280[0] = fSlow36 + self.fConst2 * self.fRec280[1];
			self.fRec282[0] = fSlow37 + self.fConst2 * self.fRec282[1];
			self.fRec281[(self.IOTA0 & 2097151) as usize] = fTemp246 + fTemp294 + fSlow38 * self.fRec281[((i32::wrapping_sub(self.IOTA0, i32::wrapping_add(((F32::min(self.fConst19, F32::max(0.0, self.fConst0 * self.fRec282[0]))) as i32), 1))) & 2097151) as usize] + fTemp332;
			self.fRec283[0] = fSlow39 + self.fConst2 * self.fRec283[1];
			let mut fTemp333: F32 = self.fRec283[0] * (self.fRec281[(self.IOTA0 & 2097151) as usize] * self.fRec280[0] + (1.0 - self.fRec280[0]) * (fTemp332 + fTemp294 + fTemp246));
			*output0 = fTemp333;
			*output1 = fTemp333;
